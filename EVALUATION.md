...
|---|---|---|---|---|---|---|---|---|---|---|
| `background.SKY` | 320x96 | 1 | L | 30720 | 6 | 11 | 0.01 | 2 | 0 | 55.2 |
| `background.MID` | 320x64 | 1 | L | 20480 | 4 | 6 | 0.13 | 0 | 0 | 14.0 |
| `background.FAR` | 320x56 | 1 | L | 17920 | 2 | 1 | 7.65 | 0 | 0 | 7.2 |
| `background.STREET` | 320x40 | 1 | M | 12800 | 6 | 12 | 0.04 | 2 | 0 | 21.7 |
...
| `player.shoot` | 24x32 | 3 | S | 2304 | 15 | 79 | 0.02 | 6 | 0 | 2.2 |
...
| `effects.bloodpool` | 20x8 | 1 | XS | 160 | 3 | 2 | 0.24 | 1 | 0 | 0.1 |
...
| `mech.FRAMES` | 64x96 | 4 | L | 24576 | 14 | 186 | 0.09 | 24 | 0 | 21.6 |
| `render_sky.BACKDROP` | 160x58 | 1 | M | 9280 | 8 | 14 | 0.15 | 1 | 0 | 16.3 |
| `sky.BACKDROP` | 160x58 | 1 | M | 9280 | 8 | 14 | 0.15 | 1 | 0 | 18.9 |
| `ground.GROUND` | 160x40 | 1 | M | 6400 | 9 | 23 | 0.09 | 0 | 0 | 11.7 |
| `walk_cycle.FRAMES` | 16x32 | 4 | S | 2048 | 13 | 92 | 0.02 | 4 | 0 | 3.0 |
| `mechdog.FRAMES` | 24x18 | 4 | S | 1728 | 7 | 44 | 0.17 | 4 | 0 | 1.9 |
| `props.HOUSE` | 46x34 | 1 | S | 1564 | 10 | 18 | 0.07 | 1 | 0 | 1.5 |
...
|---|---|---|---|
| `check_sprite.py` | 1 | 99 | 0 |
| `check_scene.py` | 1 | 99 | 0 |
| `check_dog.py` | 1 | 99 | 0 |
| `check_farmprops.py` | 1 | 99 | 0 |
| `check_foliage.py` | 1 | 99 | 0 |
| `check_game.py` | 1 | 99 | 0 |
| `check_ground.py` | 1 | 99 | 0 |
| `check_props.py` | 1 | 99 | 0 |
| `check_sky.py` | 1 | 99 | 0 |
| `check_thresholds.py` | 1 | 99 | 0 |
| `check_yardprops.py` | 1 | 99 | 0 |
| `game/check_background.py` | 1 | 99 | 0 |
| `game/check_effects.py` | 1 | 99 | 0 |
| `game/check_player.py` | 1 | 99 | 0 |
| `game/check_zombie.py` | 1 | 99 | 0 |
| `check_mechdog.py` | 1 | 95 | 0 |
| `check_mech.py` | 1 | 89 | 0 |
| `check_pixelate.py` | 1 | 84 | 0 |
| `check_modules.py` | 1 | 60 | 0 |
| `studio/check_studio.py` | 1 | 26 | 0 |
