...
|---|---|---|---|---|---|---|---|---|---|---|
| `background.SKY` | 320x96 | 1 | L | 30720 | 6 | 11 | 0.01 | 2 | 0 | 76.0 |
| `background.MID` | 320x64 | 1 | L | 20480 | 4 | 6 | 0.13 | 0 | 0 | 17.8 |
| `background.FAR` | 320x56 | 1 | L | 17920 | 2 | 1 | 7.65 | 0 | 0 | 8.5 |
| `background.STREET` | 320x40 | 1 | M | 12800 | 6 | 12 | 0.04 | 2 | 0 | 27.8 |
| `zombie.death` | 22x32 | 5 | S | 3520 | 6 | 45 | 0.02 | 0 | 0 | 2.9 |
| `player.walk` | 24x32 | 4 | S | 3072 | 12 | 100 | 0.02 | 8 | 0 | 3.8 |
| `zombie.walk` | 22x32 | 4 | S | 2816 | 6 | 38 | 0.02 | 0 | 0 | 3.5 |
| `player.shoot` | 24x32 | 3 | S | 2304 | 15 | 79 | 0.02 | 6 | 0 | 2.7 |
| `player.idle` | 24x32 | 2 | S | 1536 | 12 | 50 | 0.02 | 4 | 0 | 1.9 |
| `zombie.attack` | 22x32 | 2 | S | 1408 | 6 | 20 | 0.02 | 0 | 0 | 1.7 |
...
| `mech.FRAMES` | 64x96 | 4 | L | 24576 | 14 | 186 | 0.09 | 24 | 0 | 36.5 |
| `render_sky.BACKDROP` | 160x58 | 1 | M | 9280 | 8 | 14 | 0.15 | 1 | 0 | 24.2 |
| `sky.BACKDROP` | 160x58 | 1 | M | 9280 | 8 | 14 | 0.15 | 1 | 0 | 32.8 |
| `ground.GROUND` | 160x40 | 1 | M | 6400 | 9 | 23 | 0.09 | 0 | 0 | 14.8 |
| `walk_cycle.FRAMES` | 16x32 | 4 | S | 2048 | 13 | 92 | 0.02 | 4 | 0 | 4.9 |
| `mechdog.FRAMES` | 24x18 | 4 | S | 1728 | 7 | 44 | 0.17 | 4 | 0 | 4.3 |
| `props.HOUSE` | 46x34 | 1 | S | 1564 | 10 | 18 | 0.07 | 1 | 0 | 2.0 |
| `dog.DOG_FRAMES` | 20x14 | 4 | S | 1120 | 4 | 20 | 0.44 | 0 | 0 | 1.5 |
...
| `yardprops.WAGON` | 28x18 | 1 | XS | 504 | 6 | 10 | 0.14 | 0 | 0 | 1.5 |
...
| `yardprops.HAYSTACK` | 24x18 | 1 | XS | 432 | 6 | 12 | 0.09 | 1 | 0 | 1.6 |
| `yardprops.SCARECROW` | 14x30 | 1 | XS | 420 | 8 | 13 | 0.14 | 2 | 0 | 1.3 |
...
|---|---|---|---|
| `check_sprite.py` | 1 | 68 | 0 |
| `check_scene.py` | 1 | 68 | 0 |
| `check_dog.py` | 1 | 68 | 0 |
| `check_farmprops.py` | 1 | 68 | 0 |
| `check_foliage.py` | 1 | 68 | 0 |
| `check_game.py` | 1 | 68 | 0 |
| `check_ground.py` | 1 | 68 | 0 |
| `check_props.py` | 1 | 68 | 0 |
| `check_sky.py` | 1 | 68 | 0 |
| `check_thresholds.py` | 1 | 68 | 0 |
| `check_yardprops.py` | 1 | 68 | 0 |
| `game/check_background.py` | 1 | 68 | 0 |
| `game/check_effects.py` | 1 | 68 | 0 |
| `game/check_player.py` | 1 | 68 | 0 |
| `game/check_zombie.py` | 1 | 68 | 0 |
| `check_mechdog.py` | 1 | 64 | 0 |
| `check_mech.py` | 1 | 58 | 0 |
| `check_pixelate.py` | 1 | 53 | 0 |
| `check_modules.py` | 1 | 29 | 0 |
