...
|---|---|---|---|---|---|---|---|---|---|---|
| `background.SKY` | 320x96 | 1 | L | 30720 | 6 | 11 | 0.01 | 2 | 0 | 108.0 |
| `background.MID` | 320x64 | 1 | L | 20480 | 4 | 6 | 0.13 | 0 | 0 | 20.1 |
| `background.FAR` | 320x56 | 1 | L | 17920 | 2 | 1 | 7.65 | 0 | 0 | 9.4 |
| `background.STREET` | 320x40 | 1 | M | 12800 | 6 | 12 | 0.04 | 2 | 0 | 32.7 |
| `zombie.death` | 22x32 | 5 | S | 3520 | 6 | 45 | 0.02 | 0 | 0 | 3.1 |
| `player.walk` | 24x32 | 4 | S | 3072 | 12 | 100 | 0.02 | 8 | 0 | 4.5 |
...
| `zombie.attack` | 22x32 | 2 | S | 1408 | 6 | 20 | 0.02 | 0 | 0 | 1.6 |
| `effects.muzzle` | 16x12 | 4 | XS | 768 | 3 | 6 | 0.13 | 0 | 0 | 0.5 |
...
| `mech.FRAMES` | 64x96 | 4 | L | 24576 | 14 | 186 | 0.09 | 24 | 0 | 28.1 |
| `render_sky.BACKDROP` | 160x58 | 1 | M | 9280 | 8 | 14 | 0.15 | 1 | 0 | 38.5 |
| `sky.BACKDROP` | 160x58 | 1 | M | 9280 | 8 | 14 | 0.15 | 1 | 0 | 45.0 |
| `ground.GROUND` | 160x40 | 1 | M | 6400 | 9 | 23 | 0.09 | 0 | 0 | 15.4 |
| `walk_cycle.FRAMES` | 16x32 | 4 | S | 2048 | 13 | 92 | 0.02 | 4 | 0 | 7.1 |
...
| `render_sky.CLOUD_STRIP` | 64x12 | 1 | XS | 768 | 2 | 1 | 0.57 | 0 | 0 | 0.5 |
| `sky.CLOUD_STRIP` | 64x12 | 1 | XS | 768 | 2 | 1 | 0.57 | 0 | 0 | 0.7 |
...
| `yardprops.HAYSTACK` | 24x18 | 1 | XS | 432 | 6 | 12 | 0.09 | 1 | 0 | 1.5 |
| `yardprops.SCARECROW` | 14x30 | 1 | XS | 420 | 8 | 13 | 0.14 | 2 | 0 | 1.6 |
...
| `foliage.FLOWERPATCH` | 16x8 | 1 | XS | 128 | 5 | 4 | 0.42 | 0 | 0 | 0.3 |
| `farmprops.STUMP` | 12x9 | 1 | XS | 108 | 6 | 10 | 0.00 | 1 | 0 | 0.3 |
| `farmprops.MILKCHURN` | 8x12 | 1 | XS | 96 | 4 | 5 | 0.15 | 0 | 0 | 0.2 |
| `foliage.MUSHROOMS` | 10x8 | 1 | XS | 80 | 5 | 8 | 0.18 | 1 | 0 | 0.3 |
...
|---|---|---|---|
| `check_sprite.py` | 1 | 31 | 0 |
| `check_scene.py` | 1 | 31 | 0 |
| `check_dog.py` | 1 | 31 | 0 |
| `check_farmprops.py` | 1 | 31 | 0 |
| `check_foliage.py` | 1 | 31 | 0 |
| `check_game.py` | 1 | 31 | 0 |
| `check_ground.py` | 1 | 31 | 0 |
| `check_props.py` | 1 | 31 | 0 |
| `check_sky.py` | 1 | 31 | 0 |
| `check_thresholds.py` | 1 | 31 | 0 |
| `check_yardprops.py` | 1 | 31 | 0 |
| `game/check_background.py` | 1 | 31 | 0 |
| `game/check_effects.py` | 1 | 31 | 0 |
| `game/check_player.py` | 1 | 31 | 0 |
| `game/check_zombie.py` | 1 | 31 | 0 |
| `check_mechdog.py` | 1 | 27 | 0 |
| `check_mech.py` | 1 | 21 | 0 |
| `check_pixelate.py` | 1 | 16 | 0 |
