...
|---|---|---|---|---|---|---|---|---|---|---|
| `background.SKY` | 320x96 | 1 | L | 30720 | 6 | 11 | 0.01 | 2 | 0 | 82.4 |
| `background.MID` | 320x64 | 1 | L | 20480 | 4 | 6 | 0.13 | 0 | 0 | 19.8 |
| `background.FAR` | 320x56 | 1 | L | 17920 | 2 | 1 | 7.65 | 0 | 0 | 9.5 |
| `background.STREET` | 320x40 | 1 | M | 12800 | 6 | 12 | 0.04 | 2 | 0 | 33.3 |
| `zombie.death` | 22x32 | 5 | S | 3520 | 6 | 45 | 0.02 | 0 | 0 | 2.8 |
| `player.walk` | 24x32 | 4 | S | 3072 | 12 | 100 | 0.02 | 8 | 0 | 3.8 |
| `zombie.walk` | 22x32 | 4 | S | 2816 | 6 | 38 | 0.02 | 0 | 0 | 3.8 |
| `player.shoot` | 24x32 | 3 | S | 2304 | 15 | 79 | 0.02 | 6 | 0 | 3.2 |
...
| `sky.BACKDROP` | 160x58 | 1 | M | 9280 | 8 | 14 | 0.15 | 1 | 0 | 23.8 |
| `ground.GROUND` | 160x40 | 1 | M | 6400 | 9 | 23 | 0.09 | 0 | 0 | 15.7 |
| `walk_cycle.FRAMES` | 16x32 | 4 | S | 2048 | 13 | 92 | 0.02 | 4 | 0 | 5.3 |
| `props.HOUSE` | 46x34 | 1 | S | 1564 | 10 | 18 | 0.07 | 1 | 0 | 2.0 |
| `props.tree` | 28x40 | 1 | S | 1120 | 6 | 8 | 0.01 | 1 | 0 | 1.4 |
| `dog.DOG_FRAMES` | 20x14 | 4 | S | 1120 | 4 | 20 | 0.44 | 0 | 0 | 2.7 |
...
| `farmprops.signpost` | 8x20 | 1 | XS | 160 | 3 | 3 | 0.14 | 0 | 0 | 0.6 |
...
| `farmprops.CRATE` | 12x11 | 1 | XS | 132 | 3 | 3 | 0.14 | 0 | 0 | 0.7 |
