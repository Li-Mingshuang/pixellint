...
|---|---|---|---|---|---|---|---|---|---|---|
| `background.SKY` | 320x96 | 1 | L | 30720 | 6 | 11 | 0.01 | 2 | 0 | 86.1 |
| `background.MID` | 320x64 | 1 | L | 20480 | 4 | 6 | 0.13 | 0 | 0 | 17.7 |
| `background.FAR` | 320x56 | 1 | L | 17920 | 2 | 1 | 7.65 | 0 | 0 | 8.6 |
| `background.STREET` | 320x40 | 1 | M | 12800 | 6 | 12 | 0.04 | 2 | 0 | 30.9 |
| `zombie.death` | 22x32 | 5 | S | 3520 | 6 | 45 | 0.02 | 0 | 0 | 4.5 |
| `player.walk` | 24x32 | 4 | S | 3072 | 12 | 100 | 0.02 | 8 | 0 | 4.4 |
| `zombie.walk` | 22x32 | 4 | S | 2816 | 6 | 38 | 0.02 | 0 | 0 | 6.8 |
| `player.shoot` | 24x32 | 3 | S | 2304 | 15 | 79 | 0.02 | 6 | 0 | 5.1 |
| `player.idle` | 24x32 | 2 | S | 1536 | 12 | 50 | 0.02 | 4 | 0 | 2.3 |
| `zombie.attack` | 22x32 | 2 | S | 1408 | 6 | 20 | 0.02 | 0 | 0 | 5.1 |
...
| `effects.blood` | 8x8 | 3 | XS | 224 | 3 | 6 | 0.24 | 3 | 0 | 0.3 |
...
| `mech.FRAMES` | 64x96 | 4 | L | 24576 | 14 | 186 | 0.09 | 24 | 0 | 33.2 |
| `render_sky.BACKDROP` | 160x58 | 1 | M | 9280 | 8 | 14 | 0.15 | 1 | 0 | 26.9 |
| `sky.BACKDROP` | 160x58 | 1 | M | 9280 | 8 | 14 | 0.15 | 1 | 0 | 29.2 |
| `ground.GROUND` | 160x40 | 1 | M | 6400 | 9 | 23 | 0.09 | 0 | 0 | 15.7 |
| `walk_cycle.FRAMES` | 16x32 | 4 | S | 2048 | 13 | 92 | 0.02 | 4 | 0 | 7.5 |
| `mechdog.FRAMES` | 24x18 | 4 | S | 1728 | 7 | 44 | 0.17 | 4 | 0 | 2.5 |
| `props.HOUSE` | 46x34 | 1 | S | 1564 | 10 | 18 | 0.07 | 1 | 0 | 2.8 |
| `dog.DOG_FRAMES` | 20x14 | 4 | S | 1120 | 4 | 20 | 0.44 | 0 | 0 | 1.7 |
...
| `render_sprite.SPRITE` | 16x32 | 1 | XS | 512 | 13 | 23 | 0.02 | 1 | 0 | 1.1 |
| `yardprops.WAGON` | 28x18 | 1 | XS | 504 | 6 | 10 | 0.14 | 0 | 0 | 1.6 |
| `foliage.CHICKEN` | 12x10 | 4 | XS | 480 | 6 | 32 | 0.31 | 4 | 0 | 0.8 |
| `props.FENCE` | 32x14 | 1 | XS | 448 | 3 | 3 | 0.14 | 0 | 0 | 0.8 |
| `yardprops.WELL` | 20x22 | 1 | XS | 440 | 9 | 14 | 0.14 | 1 | 0 | 1.5 |
| `yardprops.HAYSTACK` | 24x18 | 1 | XS | 432 | 6 | 12 | 0.09 | 1 | 0 | 1.7 |
| `yardprops.SCARECROW` | 14x30 | 1 | XS | 420 | 8 | 13 | 0.14 | 2 | 0 | 1.4 |
| `foliage.BUSH` | 18x14 | 1 | XS | 252 | 4 | 3 | 0.32 | 0 | 0 | 0.5 |
| `farmprops.SIGNPOST` | 8x20 | 1 | XS | 160 | 3 | 3 | 0.14 | 0 | 0 | 0.3 |
| `farmprops.LOGPILE` | 16x10 | 1 | XS | 160 | 5 | 8 | 0.14 | 1 | 0 | 0.5 |
| `farmprops.BARREL` | 10x14 | 1 | XS | 140 | 5 | 9 | 0.14 | 0 | 0 | 0.4 |
| `props.ROCK` | 14x10 | 1 | XS | 140 | 3 | 3 | 0.15 | 0 | 0 | 0.3 |
| `farmprops.CRATE` | 12x11 | 1 | XS | 132 | 3 | 3 | 0.14 | 0 | 0 | 0.4 |
...
|---|---|---|---|
| `check_sprite.py` | 1 | 98 | 0 |
| `check_scene.py` | 1 | 98 | 0 |
| `check_dog.py` | 1 | 98 | 0 |
| `check_farmprops.py` | 1 | 98 | 0 |
| `check_foliage.py` | 1 | 98 | 0 |
| `check_game.py` | 1 | 98 | 0 |
| `check_ground.py` | 1 | 98 | 0 |
| `check_props.py` | 1 | 98 | 0 |
| `check_sky.py` | 1 | 98 | 0 |
| `check_thresholds.py` | 1 | 98 | 0 |
| `check_yardprops.py` | 1 | 98 | 0 |
| `game/check_background.py` | 1 | 98 | 0 |
| `game/check_effects.py` | 1 | 98 | 0 |
| `game/check_player.py` | 1 | 98 | 0 |
| `game/check_zombie.py` | 1 | 98 | 0 |
| `check_mechdog.py` | 1 | 94 | 0 |
| `check_mech.py` | 1 | 88 | 0 |
| `check_pixelate.py` | 1 | 83 | 0 |
| `check_modules.py` | 1 | 59 | 0 |
| `studio/check_studio.py` | 1 | 25 | 0 |
